...
export const CROSSWORD_EASY_MAX_SOLUTIONS = 10;
...
export const BONUS_POPUP_TOUCH_CLOSE_BUTTON_WIDTH = 180.0;
export const BONUS_POPUP_TOUCH_CLOSE_BUTTON_HEIGHT = 34.0;
export const BONUS_POPUP_TOUCH_CLOSE_BUTTON_TOP_INSET = 10.0;
export const BONUS_POPUP_TOUCH_CLOSE_BUTTON_TOP_MARGIN = 8.0;
...
export const LETTER_R_BASE_DESIGN = 15.0;
export const MIN_LETTER_RADIUS_FACTOR = 0.07;
export const MAX_LETTER_RADIUS_FACTOR = 0.16;
export const WHEEL_LETTER_FONT_SIZE_BASE_DESIGN = 14.0;
export const WHEEL_LETTER_VISUAL_SCALE = 1.45;
export const WHEEL_LETTER_RING_OUTSET_DESIGN = 24.0;
export const WHEEL_INTERACTION_SCALE_FACTOR = 1.4;
export const WHEEL_HIT_RADIUS_NON_SCALED_EXTRA = 3.0;
export const WHEEL_FIRST_LETTER_HIT_EXTRA = 4.0;
export const WHEEL_FIRST_LETTER_INNER_SIDE_EXTRA = 5.0;
export const DEBUG_DRAW_WHEEL_HIT_AREAS = false;
export const WHEEL_R = 82.0;
export const GUESS_OVERLAY_TILE_SIZE = 36.0;
export const GUESS_OVERLAY_TILE_PAD = 5.0;
export const GUESS_OVERLAY_PANEL_PAD_X = 14.0;
export const GUESS_OVERLAY_PANEL_PAD_Y = 10.0;
export const GUESS_OVERLAY_PANEL_BOTTOM_GAP = 12.0;
