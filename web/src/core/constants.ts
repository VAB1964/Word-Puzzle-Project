...
export const BONUS_POPUP_TOUCH_BUTTON_WIDTH = 180.0;
export const BONUS_POPUP_TOUCH_BUTTON_HEIGHT = 34.0;
export const BONUS_POPUP_TOUCH_BUTTON_GAP = 12.0;
export const BONUS_POPUP_TOUCH_BUTTON_TOP_MARGIN = 8.0;
export const BONUS_POPUP_TOUCH_BUTTON_SCROLL_STEP = 90.0;
