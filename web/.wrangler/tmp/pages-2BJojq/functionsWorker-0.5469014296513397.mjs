...
function pcmToWav(pcm, sampleRate = 24e3) {
  ...
  const writeAscii = /* @__PURE__ */ __name((offset, value) => {
...
// ../.wrangler/tmp/pages-2BJojq/functionsRoutes-0.4744465199365826.mjs
var routes = [
  {
...
// C:/Users/vince/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/vince/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-Cu893z/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Cu893z/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5469014296513397.mjs.map
