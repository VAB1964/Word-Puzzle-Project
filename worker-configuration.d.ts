/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=worker/dev.env` (hash: 05fb4d120514c5c289c78a4f0fa63ccd)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGIN: string;
	WORD_PUZZLE_ROOMS: DurableObjectNamespace<import("./worker/src/index").WordPuzzleRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/src/index");
		durableNamespaces: "WordPuzzleRoom";
	}
